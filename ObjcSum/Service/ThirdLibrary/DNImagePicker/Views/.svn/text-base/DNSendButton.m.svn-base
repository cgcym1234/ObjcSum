...
#define kSendButtonFont  [UIFont boldSystemFontOfSize:16]
static NSString *const dnSendButtonTintNormalColor = @"#000000";
...
- (void)setupViews
{
    ...
    _sendButton.titleLabel.font = kSendButtonFont;
