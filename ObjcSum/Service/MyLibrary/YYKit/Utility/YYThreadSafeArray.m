...
- (id)randomObject {
    LOCK(id o = [_arr yy_randomObject]) return o;
}

- (id)objectOrNilAtIndex:(NSUInteger)index {
    LOCK(id o = [_arr yy_objectOrNilAtIndex:index]) return o;
}

- (void)removeFirstObject {
    LOCK([_arr yy_removeFirstObject]);
}

- (id)popFirstObject {
    LOCK(id o = [_arr yy_popFirstObject]) return o;
}

- (id)popLastObject {
    LOCK(id o = [_arr yy_popLastObject]) return o;
}

- (void)appendObjects:(NSArray *)objects {
    LOCK([_arr yy_appendObjects:objects]);
}

- (void)prependObjects:(NSArray *)objects {
    LOCK([_arr yy_prependObjects:objects]);
}

- (void)insertObjects:(NSArray *)objects atIndex:(NSUInteger)index {
    LOCK([_arr yy_insertObjects:objects atIndex:index]);
}

- (void)reverse {
    LOCK([_arr yy_reverse]);
}

- (void)shuffle {
    LOCK([_arr yy_shuffle]);
}
