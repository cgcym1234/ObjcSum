 ...
 *  @return NSData数据
 */
+(NSData *)En_AESandBase64ToData:(NSString *)str privateKey:(NSString *)privateKey
{
    NSData *data_aes = [FBEncryptorAES encryptData:[str dataUsingEncoding:NSUTF8StringEncoding]
                                               key:[privateKey dataUsingEncoding:NSASCIIStringEncoding]];
 ...
 *  @return NSString数据
 */
+(NSString *)En_AESandBase64EnToString:(NSString *)str privateKey:(NSString *)privateKey
{
    NSData *data_aes = [FBEncryptorAES encryptData:[str dataUsingEncoding:NSUTF8StringEncoding]
                                               key:[privateKey dataUsingEncoding:NSASCIIStringEncoding]];
