...
@property (nonatomic, readonly) NSInteger dayOfYear; ///< dayOfYear component (1~366)
...
/**
 ...
 If can not parse the string, returns nil.
 */
+ (NSDate *)yy_dateWithString:(NSString *)dateString formatString:(NSString *)format timeZone:(NSTimeZone *)timeZone locale:(NSLocale *)locale;
